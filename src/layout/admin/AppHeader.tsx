    ...
    <>
      <header className="sticky top-0 z-99999 flex w-full border-gray-200 bg-white lg:border-b dark:border-gray-800 dark:bg-gray-900">
        <div className="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
          <div className="flex w-full items-center justify-between gap-2 border-b border-gray-200 sm:gap-4 lg:justify-normal lg:border-b-0 dark:border-gray-800">
            <button
            ...
            {balanceData && (
              <div className="rounded-lg bg-blue-50 px-4 py-2 dark:bg-blue-900">
                ...
                <p className="text-lg font-bold text-blue-600 dark:text-blue-400">
                  {Number(balanceData.balance).toLocaleString("vi-VN")} ₫
                </p>
              </div>
            )}
            ...
            <div>
              <div className="flex w-full justify-end px-3 py-2">
                <button
                  ...
                  className="flex rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700"
                >
                  + &nbsp; Tạo cửa hàng
                </button>
              </div>
